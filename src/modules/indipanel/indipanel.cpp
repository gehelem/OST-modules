...
void IndiPanel::newProperty(INDI::Property pProperty)
{
    ...
    switch (pProperty.getType())
    {
        ...
        case INDI_NUMBER:
        {
            ...
            for (int i = 0; i < pProperty.getNumber()->count(); i++)
            {
                createOstElement(devpro, pProperty.getNumber()[i].name, pProperty.getNumber()[i].label, false);
                //setOstElementValue(devpro, pProperty.getNumber()[i].name, pProperty.getNumber()[i], false);
                //setOstElementAttribute(devpro, pProperty.getNumber()[i].name, "min", pProperty.getNumber()[i].min, false);
                //setOstElementAttribute(devpro, pProperty.getNumber()[i].name, "max", pProperty.getNumber()[i].max, false);
                //setOstElementAttribute(devpro, pProperty.getNumber()[i].name, "step", pProperty.getNumber()[i].step, false);
                //setOstElementAttribute(devpro, pProperty.getNumber()[i].name, "format", pProperty.getNumber()[i].format, i == vp->nnp - 1);
                //setOstElementAttribute(devpro,pProperty.getNumber()[i].name,"aux0",pProperty.getNumber()[i].aux0,false);
                //setOstElementAttribute(devpro,pProperty.getNumber()[i].name,"aux1",pProperty.getNumber()[i].aux1,false);
            }
            break;
        }
        /*case INDI_SWITCH:
...
void IndiPanel::newNumber(INumberVectorProperty *nvp)
{
    ...
    {
        setOstElementValue(devpro, npProperty.getNumber()[i].name, npProperty.getNumber()[i].value, false);
        setOstElementAttribute(devpro, npProperty.getNumber()[i].name, "min", npProperty.getNumber()[i].min, false);
        setOstElementAttribute(devpro, npProperty.getNumber()[i].name, "max", npProperty.getNumber()[i].max, false);
        setOstElementAttribute(devpro, npProperty.getNumber()[i].name, "step", npProperty.getNumber()[i].step, false);
        setOstElementAttribute(devpro, npProperty.getNumber()[i].name, "format", npProperty.getNumber()[i].format, false);
    }
